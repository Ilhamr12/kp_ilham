...
//proses hapus gambar
      ...
      $sql_f = "UPDATE tb_karyawan set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenis_kelamin='$jenis_kelamin', agama='$agama', alamat='$alamat', no_tlp='$no_tlp', jabatan='$jabatan', foto ='$fotobaru' WHERE id_karyawan='$id_karyawan'";
      ...
      echo "<br><a href='data_karyawan.php'>Kembali Ke data karyawan</a>";
    }
 } //akhir ubah foto
 else { //hanya untuk mengubah data
   $sql_d   = "UPDATE tb_karyawan set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenis_kelamin='$jenis_kelamin', agama='$agama', alamat='$alamat', no_tlp='$no_tlp', jabatan='$jabatan' WHERE id_karyawan='$id_karyawan'";
