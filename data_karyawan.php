...
<head>
    ...
    <!-- View CSS-->
    <link href="view/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet" media="all">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                                <form action="data_karyawan_save.php" enctype="multipart/form-data" method="post">
                                        ...
                                        <table class="table table-borderless table-striped table-earning" >  
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" required="" name="tmp_tgl_lahir" autocomplete="off">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Jenis Kelamin</td>
                                                ...
                                                <tr>
                                                    <td>No Telepon</td>
                                                    <td><input type="text" autocomplete="off" maxlength="18" required="" class="form-control" name="no_tlp"></td>
                                                </tr>
                                                <tr>
                                                    <td>Jabatan</td>
                                                    <td>
